        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12">
          <nav className="flex items-center justify-between py-6">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-accent text-accent-foreground hover:bg-accent/90 font-medium text-sm transition-colors"
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  disabled={isLoading}
                  style={{ cursor: isLoading ? 'not-allowed' : 'pointer' }}
                  className="google-btn flex items-center gap-2 px-6 py-3 rounded-md bg-accent text-accent-foreground hover:bg-accent/90 font-medium text-base transition-colors active:scale-95"
